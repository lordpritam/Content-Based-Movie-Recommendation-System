...
def fetch_poster(movie_id):
    url = 'https://api.themoviedb.org/3/movie/{}?api_key=fe88880200be1d8b9068a47a2fc959f9&language=en-US'.format(
        movie_id)
...
option = st.selectbox('Enter A Movie Name For Recommendation', movies['title'].values)
